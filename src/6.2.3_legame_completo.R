...
#str(hls)
#
#plot(hls, hang = -1, axes = FALSE, xlab = " Metodo gerarchico agglomerativo", sub = "del legame completo")
...
#
#print("Inserimento delle regioni in 4 cluster (metodo del legame completo):")
#sort(cutree(hls , k = 4))
#print("Numerosità dei 4 cluster (metodo del legame completo):")
