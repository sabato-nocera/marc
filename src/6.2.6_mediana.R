...
#str(hls)
#
#plot(hls, hang =-1, axes=FALSE, xlab=" Metodo gerarchico agglomerativo", sub ="della mediana")
...
#
#print("Inserimento delle regioni in 4 cluster (metodo della mediana):")
#sort(cutree(hls , k = 4))
#print("Numerosità dei 4 cluster (metodo della mediana):")
